...
class SecurityHeadersSubscriber implements EventSubscriberInterface
{
    public function onKernelResponse(ResponseEvent $event): void
    {
        ...
        // Désactivation minimale pour éviter les erreurs de "unrecognized feature"
